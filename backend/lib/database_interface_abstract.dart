...
abstract class DatabaseInterfaceAbstract {
  ///
  /// Get all data from the database related to the given field.
  Future<Map<String, dynamic>> getAll();

  ///
  /// Get data from the database related to the given field and [id].
  /// If the data doesn't exist, a [MissingDataException] will be thrown.
  Future<Map<String, dynamic>> getById({required String id});

  ///
  /// Put all data into the database related to the given field.
  ...
  ///
  /// Put data into the database related to the given field and [id].
