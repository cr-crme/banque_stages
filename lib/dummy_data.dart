  ...
  jobs.add(
    Job(
      ...
      sstEvaluation: JobSstEvaluation(
        questions: {
          '1': "Oui",
          '1+t': 'Peu souvent, à la discrétion des employés.',
          '3': ['Un diable'],
          '5': ['Des ciseaux'],
          '9': ['Des solvants', 'Des produits de nettoyage'],
          '12': ['Bruyant'],
          '12+t': 'Bouchons a oreilles',
          '15': "Oui",
          '18': "Non",
        },
        date: DateTime.now(),
  ...
  jobs.add(
    Job(
      ...
      sstEvaluation: JobSstEvaluation(
        questions: {
          '1': "Oui",
          '1+t': 'Plusieurs fois par jour, surtout des pots de fleurs.',
          '3': ['Un diable'],
          '5': ['Un couteau', 'Des ciseaux', 'Un sécateur'],
          '7': ['Des pesticides', 'Engrais'],
          '12': ['Bruyant'],
          '15': "Non",
          '18': "Oui",
          '18+t': 'L\'élève ne portait pas ses gants malgré plusieurs avertissements, '
  ...
  jobs.add(
    Job(
      ...
      sstEvaluation: JobSstEvaluation(
        questions: {
          '1': "Oui",
          '1+t': 'En début et en fin de journée, surtout des pots de fleurs.',
          '3': ['Un diable'],
          '5': ['Un couteau', 'Des ciseaux'],
          '7': ['Des pesticides', 'Engrais'],
